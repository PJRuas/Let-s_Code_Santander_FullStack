...
const myModal = (function(){  //módulo do modal (uma função factory que é iniciada automaticamente) 
    ...
    function removeInputFields(){ //remove todos os itens da lista "ul" do modal, para evitar duplicidade de inputs quando chamar "open modal" novamente
        for (iten of _inputs){  //verifica quantos campos de "input" foram criados no modal
            _ul.removeChild(iten.parentNode)  //remove os campos
        }
    }
